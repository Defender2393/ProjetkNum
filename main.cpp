...
int main() {
  ...
  //  cin >> FolderNumber; // Benutzer gibt Ordnernummer als String ein
    FolderNumber="0";
    Particle ParticleData(getfolder(), FolderNumber, DevMode,IsTropfenOrSpray);
    if (DevMode) {
    ...
    if (IsTropfenOrSpray==2) {
        string TimeHelp[141]{    "0","0.02","0.04","0.06","0.08","0.1","0.12","0.14","0.16","0.18",
