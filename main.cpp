...
int main() {
    ...
    if (IsTropfenOrSpray == 2) {
        ...
        string TimeHelp[141]{
            ...
            "1.12", "1.14", "1.16", "1.18", "1.2", "1.22", "1.24", "1.26", "1.28", "1.3", "1.32", "1.34", "1.36",
            "1.38", "1.4", "1.42", "1.44", "1.46", "1.48", "1.5", "1.52", "1.54", "1.56", "1.58", "1.6", "1.62", "1.64",
            "1.66", "1.68", "1.7", "1.72", "1.74", "1.76", "1.78", "1.8", "1.82", "1.84", "1.86", "1.88", "1.9", "1.92",
            "1.94", "1.96", "1.98", "2", "2.02", "2.04", "2.06", "2.08", "2.1", "2.12", "2.14", "2.16", "2.18", "2.2",
            "2.22", "2.24", "2.26", "2.28", "2.3", "2.32", "2.34", "2.36", "2.38", "2.4", "2.42", "2.44", "2.46",
